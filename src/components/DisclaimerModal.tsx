      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="mb-4 text-center font-serif text-2xl text-foreground">{t.disclaimer.title}</h2>
            ...
            <Button onClick={dismiss} className="w-full" size="lg">{t.disclaimer.button}</Button>
          </motion.div>
        </motion.div>
      )}
    </AnimatePresence>
